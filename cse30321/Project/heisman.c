...
void fill_array_qb(struct qb* quarterback) {
 ...
 while(fgets(line, sizeof(line), qbPtr)) {
  ...
  //printf("%s        %s      %s              %s      %d      %d      %d      %d      %d\n", quarterback[i].position, quarterback[i].name_first, quarterback[i].name_last, quarterback[i].school, quarterback[i].yds_pass, quarterback[i].tds_pass, quarterback[i].intercepts, quarterback[i].yds_rush, quarterback[i].tds_rush);
  i++;
 }
}
...
void fill_array_rb(struct rb* runningback) {
 ...
 //printf("%s %s %s   %s      %d      %d      %d      %d\n", runningback[i].position, runningback[i].name_first, runningback[i].name_last, runningback[i].school, runningback[i].yds_rush, runningback[i].tds_rush, runningback[i].yds_rec, runningback[i].tds_rec);
 i++;
 }
}
